                    ...
                    <%= case @messenger do %>
                        <%= "Administrados" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-admin(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-admin(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-admin(3).webp") %>" alt="Third slide">
                            </div>
                        <%= "Virtualizacion" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-virtual(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-virtual(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-virtual(3).webp") %>" alt="Third slide">
                            </div>

                        <%= "Comunicaciones" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Com(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Com(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Com(3).webp") %>" alt="Third slide">
                            </div>

                        <%= "Ciberseguridad" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Seguridad(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Seguridad(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Seguridad(3).webp") %>" alt="Third slide">
                            </div>

                        <%= "Microsoft" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-microsoft(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-microsoft(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-microsoft(3).webp") %>" alt="Third slide">
                            </div>

                        <%= "MonitoreoDeRed" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Red(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Red(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Red(3).webp") %>" alt="Third slide">
                            </div>

                        <%= "Respaldo" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Respaldo(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Respaldo(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Respaldo(3).webp") %>" alt="Third slide">
                            </div>

                        <%= "SeguridadFisica" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-SF(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-SF(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-SF(3).webp") %>" alt="Third slide">
                            </div>

                        <%= "Telefonia" -> %>
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Tel(1).webp") %>" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Tel(2).webp") %>" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<%= Routes.static_path(@conn, "/images/Carousel-Tel(3).webp") %>" alt="Third slide">
                            </div>
    ...
    <div class="row">
        <div class="col-12 pr-4 pl-4">
            ...
            <%= case @messenger do %>
                <%= "Administrados" -> %>
                    <p class="text-justify">
                        Realizaremos un levantamiento de su entorno tecnológico para saber en donde estás y hacia donde deben dirigirse los esfuerzos del área de TI, y dependiendo de las necesidades su negocio y del presupuesto comprendido para el área podemos asignar ingenieros altamente capacitados en sitio o implementar una gestión remota, entregamos soluciones hechas a la medida de sus necesidades.
                    </p>
                <%= "Virtualizacion" -> %>
