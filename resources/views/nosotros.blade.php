        ...
        <div class="container-fluid overflow-hidden">
            <div class="row mt-5 p-4 p-lg-5">
                ...
                <div class="col-12 col-md-6 order-md-2 overflow-hidden anim_l">
                    <img class="w-100" src="<%= Routes.static_path(@conn, "/images/tecnologia-humana.jpg") %>" alt="">
                </div>
            ...
            <div class="row mt-5 mb-5 p-4 p-lg-5 mision_vision">
                <div class="col-12 col-md-6 col-lg-6 mt-5 mb-5 pl-lg-5 pr-lg-5 text-center">
                    <img class="about_img" src="<%= Routes.static_path(@conn, "/images/Mision.svg") %>" alt="">
                    <br><br>
                    <h2><b>Misión</b></h2><br>
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5 mb-5 pl-lg-5 pr-lg-5 text-center">
                    <img class="about_img" src="<%= Routes.static_path(@conn, "/images/Vision.svg") %>" alt="">
                    <br><br>
                    <h2><b>Visión</b></h2><br>
            ...
            <div class="row mb-5 pl-4 pr-4 pl-lg-5 pr-lg-5 pt-0 text-center">
                <div class="col-12 col-md-6 col-lg-4 pr-lg-5 mt-5 mb-5 text-justify">
                    <div class="text-center"><img id="personas_img"
                            src="<%= Routes.static_path(@conn, "/images/personas.svg") %>" alt=""></div>
                    <br>
                ...
                <div id="trust" class="col-lg-4 mt-5 mb-5 text-justify overflow-hidden">
                    <img src="<%= Routes.static_path(@conn, "/images/confianza-434w.jpg") %>" alt="">
                </div>
                <div class="col-12 col-md-6 col-lg-4 pl-lg-5 mt-5 mb-5 text-justify">
                    <div class="text-center"><img id="personas_img"
                            src="<%= Routes.static_path(@conn, "/images/chip.svg") %>" alt=""></div>
                    <br>
                ...
                <div class="col-12 col-md-6 mt-5 mb-5 mt-lg-0 pr-lg-5 pl-lg-5 text-justify">
                    <div class="text-center"><img id="personas_img"
                            src="<%= Routes.static_path(@conn, "/images/base-de-datos.svg") %>" alt=""></div>
                    <br>
                ...
                <div class="col-12 col-md-6 mt-5 mb-5 mt-lg-0 pr-lg-5 pl-lg-5 text-justify">
                    <div class="text-center"><img id="personas_img"
                            src="<%= Routes.static_path(@conn, "/images/bajo.svg") %>" alt=""></div>
                    <br>
            ...
            <div class="row mt-5 mb-5 pl-lg-5 pr-lg-5 pt-3 bg-secondary text-center">
                ...
                <div class="col-12 col-lg-6 pr-lg-5 mt-1 mb-2 text-justify text-justify">
                    <h2 class="text-white">
                        <img class="hombre pr-lg-5" src="<%= Routes.static_path(@conn, "/images/hombre.svg") %>" alt="">
                        <b>Marco Piña</b>
                ...
                <div class="col-12 col-lg-6  mt-1 mb-2 text-justify">
                    <h2 class="text-white">
                        ...
                        <a class="linkedin" target="_blank"
                            href="https://www.linkedin.com/in/sergio-ibarra-03b74323/"><span class="icon-linkedin-with-circle"></span></a>
                    </h2>
                </div>
            </div>
        </div>
